...
(cl:defmethod cl:initialize-instance :after ((m <motor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'motor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sena_message-msg:<motor> is deprecated: use sena_message-msg:motor instead.")))

(cl:ensure-generic-function 'motor1-val :lambda-list '(m))
(cl:defmethod motor1-val ((m <motor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sena_message-msg:motor1-val is deprecated.  Use sena_message-msg:motor1 instead.")
  (motor1 m))

(cl:ensure-generic-function 'motor2-val :lambda-list '(m))
(cl:defmethod motor2-val ((m <motor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sena_message-msg:motor2-val is deprecated.  Use sena_message-msg:motor2 instead.")
  (motor2 m))

(cl:ensure-generic-function 'motor3-val :lambda-list '(m))
(cl:defmethod motor3-val ((m <motor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sena_message-msg:motor3-val is deprecated.  Use sena_message-msg:motor3 instead.")
  (motor3 m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<motor>)))
  ...
  "65986bed022cdc1fac2edc1016acb2c6")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'motor)))
  "Returns md5sum for a message object of type 'motor"
  "65986bed022cdc1fac2edc1016acb2c6")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<motor>)))
  ...
  (cl:format cl:nil "float32 motor1~%float32 motor2~%float32 motor3~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'motor)))
  "Returns full string definition for message of type 'motor"
  (cl:format cl:nil "float32 motor1~%float32 motor2~%float32 motor3~%~%"))
