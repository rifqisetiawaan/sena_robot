...
robot_radius = 0.22   # This should be set to your robot's actual radius
...
def encoder_callback(data):
    ...
    vy = v3 - (v2 * math.sin(math.radians(30))) - (v1 * math.sin(math.radians(30)))
    vth = (v1 / robot_radius) + (v2 / robot_radius) + (v3 / robot_radius)
